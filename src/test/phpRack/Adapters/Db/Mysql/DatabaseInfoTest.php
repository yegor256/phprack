...
/**
 * @see phpRack_Adapters_Db_Mysql_TestCase
 */
require_once PHPRACK_PATH . '/../test/phpRack/Adapters/Db/Mysql/TestCase.php';

class phpRack_Adapters_Db_Mysql_DatabaseInfoTest extends phpRack_Adapters_Db_Mysql_TestCase
{
